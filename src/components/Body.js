  ...
  return (
    <div>
      ...
      <div className="m-auto overflow-hidden max-w-[50rem] p-8">
        <div className="m-auto text-center leading-[2.3rem] font-bold">
        ...
        <div className="flex justify-center mt-4">
          <a
            href={CV}
            className="border border-[#558bbd] text-center hover:bg-white transition-all duration-300 ease-in text-[#558bbd] text-sm font-bold rounded-lg bg-transparent p-2"
          >
            Download CV
          </a>
          <a
            href="/contact"
            className="bg-[#4bd5ff] text-[#558bbd] text-center text-sm hover:bg-white transition-all duration-300 ease-in font-semibold p-3 rounded-lg ml-4"
          >
            Let's tolk
          </a>
        </div>
